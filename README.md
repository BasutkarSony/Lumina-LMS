...
## Hackathon Context
Lumina LMS was built in **48 hours** for the Hackathon 2026 challenge to demonstrate an end‑to‑end learning platform with AI assistance, responsive UI, and production‑ready deployment on Vercel.

---
*This repository is production‑ready for Vercel and includes all necessary documentation for reviewers.*
